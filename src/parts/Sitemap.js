        ...
        <aside className="container mx-auto">
          <div className="flex flex-wrap md:space-x-4 justify-center">
            ...
            <div className="w-full md:w-2/12 mb-4 md:mb-0 accordion">
              ...
              <ul className="h-0 invisible md:h-auto md:visible overflow-hidden">
                <li>
                  <Link to="/terms-and-conds" className="hover:underline py-1 block">Terms & Conds</Link>
                </li>
                <li>
                  <Link to="/priacy-policy" className="hover:underline py-1 block">Privacy Policy</Link>
                </li>
                <li>
              ...
              <form action="#">
                <label className="relative w-full">
                  ...
                  <button className="bg-pink-400 absolute rounded-xl right-0 p-3 text-white">
                    <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current" fill="none" xmlns="http://www.w3.org/2000/svg">
