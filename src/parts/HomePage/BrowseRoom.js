        ...
        <div className="grid grid-rows-2 grid-cols-9 gap-4">
          ...
          <div className="relative col-span-9 row-span-1 md:col-span-4 card" style={{ height: 180 }}>
            <div className="card-shadow rounded-xl">
              <img src="images/content/image-catalog-1.png" alt="" className="w-full h-full object-cover overlay overflow-hidden rounded-xl" />
            </div>
          ...
          <div className="relative col-span-9 row-span-1 md:col-span-2 md:row-span-2 card">
            <div className="card-shadow rounded-xl">
              <img src="images/content/image-catalog-4.png" alt="" className="w-full h-full object-cover overlay overflow-hidden rounded-xl" />
            </div>
          ...
          <div className="relative col-span-9 row-span-1 md:col-span-3 md:row-span-2 card">
            <div className="card-shadow rounded-xl">
              <img src="images/content/image-catalog-3.png" alt="" className="w-full h-full object-cover overlay overflow-hidden rounded-xl" />
            </div>
            <div className="overlay inset-0 md:bottom-auto flex justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12">
               <h3 className="text-lg font-semibold"> 
                 Bed Room
          ...
          <div className="relative col-span-9 row-span-1 md:col-span-4 card" style={{ height: 180 }}>
            <div className="card-shadow rounded-xl">
              <img src="images/content/image-catalog-2.png" alt="" className="w-full h-full object-cover overlay overflow-hidden rounded-xl" />
            </div>
            <div className="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
               <h3 className="text-lg font-semibold"> 
                 Children Room
               </h3>
               <span className="">1807 items</span>
            </div>
            <a href="details.html" className="stretched-link">
